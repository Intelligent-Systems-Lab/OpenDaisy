...
class DaisyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Join = channel.stream_stream(
                '/daisyfl.proto.DaisyService/Join',
...
class DaisyServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_DaisyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'daisyfl.proto.DaisyService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class DaisyService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Join(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/daisyfl.proto.DaisyService/Join',
