...
# ==============================================================================
"""Base asynchronous client logic for federated learning."""
from daisyfl.common import EvaluateIns, EvaluateRes, FitIns, FitRes

from ..client_logic import ClientLogic


class BaseAsyncClientLogic(ClientLogic):
    """Base asynchronous Daisy Client operational logic definition."""
